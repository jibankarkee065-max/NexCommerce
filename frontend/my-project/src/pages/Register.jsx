       ...
       <form  onSubmit={handleSubmit} className="w-full max-w-md bg-white p-8 rounded-lg border shadow-sm ">
        <div className="flex justify-center mb-6">
         ...
         <div className="mb-4">
          ...
          className="w-full p-2 border rounded" placeholder="Enter your contact number"
          />
         </div>
         ...
         <Link to ="/register" className="text-blue-500"> Login</Link>
            ...
            <div className="h-full flex flex-col justify-center">
              ...
              <img src="/register.webp" alt=" Login to Account" className="h-screen w-full object-cover" />
            </div>
            </div>
    </div>
  )
