...
import { HiOutlineAcademicCap, HiShoppingBag } from "react-icons/hi";
    ...
    <div className="container mx-auto grid grid-col-1 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="flex   flex-col items-center">
            <div className="p-4 rounded-full mb-4">
              ...
              <p className="text-gray-600 text-sm tracking-tighter"> 100% secured checkout product process</p>
        </div>
